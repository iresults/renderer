...
/**
 * An enhanced version of the PHPWord TemplateProcessor
 */
class Template extends TemplateProcessor
{
     ...
     */
    private const EXPRESSION_PATTERN = '!{[a-zA-Z0-9.]*}!i';
    ...
    public function __construct($strFilename)
    {
        ...
        $this->tempFileName = Iresults::getTempPath() . str_replace(
                '.',
                '_',
     ...
     * @return $this
     */
    public function assign(string $key, $value): Template
    {
     ...
     * @return $this
     */
    public function assignMultiple(array $values): Template
    {
    ...
    /**
     * Return the template variable container
     *
     * @return array
     */
    public function getTemplateVariableContainer(): array
    {
     ...
     */
    public function replaceString($search, $replace, bool $regularExpression)
    {
    ...
    /**
     * Return the templates document XML data
     *
     * @return string
     */
    ...
    /**
     * Try to fetch the value for the given key path
     *
